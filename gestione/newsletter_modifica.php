...
if($manager_sql->update_newsletter($id, $rag_soc, $indirizzo, $citta, $cap, $piva, $cf, $referente, $mail, $tel, $cell1, $cell2, $sito,$prov)){
   // header('location: http://www.hqdesign.it/newsletters/common/inserisci_utente.php?mail=aaa@aaa.it');
    echo '1';
}
