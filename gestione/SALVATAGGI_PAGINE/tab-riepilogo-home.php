<style>
.riepilogo_ordini { border-collapse:collapse; background-color:#CCCCCC}
.riepilogo_ordini thead th { background-color:#999999; color:#fff; border-bottom:solid 1px #666666; border-top:solid 2px #666}
.riepilogo_ordini tbody td { border-bottom:solid 1px #fff; height:30px}
.riepilogo_ordini tbody tr:hover td { background-color:#666666; color:#fff; cursor:pointer }
.content_in_stampa{ display: none; clear: both; width: 100%}
</style>
<div style="height:400px">
        
<div style="height:400px; float:left; position:relative">
        	<p style="background-color:#FF9933; padding:5px">Riepilogo </p>
            <div style="background-color:#CCCCCC; padding-top:10px; position:relative; top:-20px">
			
  				<div id="tabs_grouping">
	
                    <ul>
                        <li><a href="#tabs-grouping-1">Grafica</a></li>
                        <li><a href="#tabs-grouping-12">Allestimenti</a></li>
                        <li><a href="#tabs-grouping-2">Laboratorio</a></li>
                        <li><a href="#tabs-grouping-10">Transfer</a></li>
                        <li><a href="#tabs-grouping-3">Web</a></li>
                        <li><a href="#tabs-grouping-4">Software</a></li>
                        
                        <li style="margin-left:40px"><a href="#tabs-grouping-5">Ordini</a></li>
                        <li><a href="#tabs-grouping-6">Preventivi</a></li>
                        <li><a href="#tabs-grouping-11">Archivio</a></li>
                        <li style="margin-left:40px"><a href="#tabs-grouping-7">In Stampa</a></li>
                        <li><a href="#tabs-grouping-8">In Magazzino</a></li>
                        <li><a href="#tabs-grouping-9">Consegnati</a></li>
                    </ul>
...
<input type="hidden" name="id_scheda" id="id_scheda_to_modify_admin" />
<table cellpadding="0" cellspacing="0">
            	<tr>
                	<td align="left">Titolo:</td>
                    <td align="left"><input type="text" style="width:250px" name="titolo_scheda" id="ts_mod_admin"/></td>
                ...
                <tr>
                    ...
                    <td align="left"><input type="text" class="data_consegna" id="dtcons_mod_admin" name="data_consegna"/></td>
                ...
                <tr class="content_in_stampa">
                    ...
                    <td>
                        data <input type="text" name="data_ritiro" class="data_consegna" style="width:100px" />
                        <br /> 
                        &nbsp; ora <input type="text" name="ora_ritiro"  style="width:60px" />
                    </td>
                 ...
                 <tr>
                	<td colspan="4" align="left">Note:<br /> <textarea  name="note" style="width:630px; height:100px" id="nt_mod_admin"></textarea></td>
                </tr>
                 <tr>
                	<td colspan="4" align="left">Note Operatore:<br /> <textarea  name="noteoperatore" style="width:630px; height:100px" id="ntop_mod_admin"></textarea></td>
                </tr>
                <tr>
                 ...
                 <td colspan="4" align="left" >
                        Costo:<br />
                        <textarea name="costo_lavoro" style="width:300px; height:100px" id="costo_lavoro_adm"/> </textarea>
                    </td>
                </tr>
            </table>
   </form>       
