...
<div style="height:400px; float:left; position:relative; ">
 ...
 <table cellpadding="5">
            ...
            <tr>
                ...
                <td ></td>
                <td><img src="images/modify.png" width="15" height="15" class='modify_cat' onclick="modify_newsletter(<?php echo $id_cliente?>)"></td>
                <td><img src="images/trash.png" width="15" height="15" class='modify_cat' onclick="delete_newsletter(<?php echo $id_cliente?>, '<?php echo addslashes($nome_cliente)?>')"></td>
            </tr>
            <?php		
				}
			?>
