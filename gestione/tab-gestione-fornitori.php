...
<div style="height:400px; float:left; position:relative; ">
 ...
 <table cellpadding="5">
            ...
            <tr>
                ...
                <td ></td>
                <td><img src="images/modify.png" width="15" height="15" class='modify_cat' onclick="modify_fornitore(<?php echo $id_cliente?>)"></td>
                <td><img src="images/trash.png" width="15" height="15" class='modify_cat' onclick="delete_fornitore(<?php echo $id_cliente?>, '<?php echo addslashes($nome_cliente)?>')"></td>
            </tr>
            <?php		
				}
			?>
         ...
         <div id="dialog-form-modifica-fornitore" title="Modifica Fornitore">
        ...
        <div style="position:relative; float:left; margin-left:20px; height:300px">
            <p style="background-color:#FF9933; padding:5px">Aggiungi Nuovo Fornitore </p>
            <div style="background-color:#CCCCCC; padding-top:10px; position:relative; top:-20px">
            <form  method="post" id="form_nuovo_fornitore">
                <table>
                <tr>
                	<td colspan="2">Ragione Sociale: <input type="text" name="rag_soc" style="width:300px"></td>
                </tr>
                <tr>
                ...
                <tr><td colspan="2">E-mail: <input type="text" name="mail" style="width:300px"></td></tr>
		...
		<tr><td colspan="2"><hr width="100%" /></td></tr>
                ...
                <tr><td><input type="button" value="Aggiungi" id="btn_nuovo_fornitore"></td><td></td></tr>
                </table>
            </form>
            </div>
