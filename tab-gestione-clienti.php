...
<div style="height:400px; float:left; position:relative; ">
 ...
 <table class="table-segreteria" >
            <tr><th width="250" align="left">Ragione Sociale</th><th width="150" align="left">Citt&aacute;</th><th width="15">&nbsp;</th><th width="15">&nbsp;</th></tr>
 </table>
 ...
 <table class="table-segreteria" >
			...
			?>
            <tr>
            	<td width="250" align="left"><?php echo $nome_cliente ?></td>
                
                <td width="150" align="left"><?php echo $citta_cliente ?></td>
               
                <td width="20"><img src="gestione/images/modify.png" width="15" height="15" class='modify_cat' onclick="modify_cliente(<?php echo $id_cliente?>)"></td>
                <td width="20"><img src="gestione/images/trash.png" width="15" height="15" class='modify_cat' onclick="delete_cliente(<?php echo $id_cliente?>, '<?php echo addslashes($nome_cliente)?>')"></td>
            </tr>
            <?php		
				}
			?>
